...
class EntitiesList(QWidget):
    ...
    def open_edit_dialog(self, index):
        # TODO: Удалить. Окна сущностей долдны отправлять сигнал о том, что объект сохранили. Аргумент - флаг необходимости закрытия окна (типа Сохранить и СхранитьЗакрыть) 
        ...
        (self.func_click_on_entity or self.double_clicked.emit)(entity)
